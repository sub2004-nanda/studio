...
export default function CoachPage() {
    const [messages, setMessages] = useState<Message[]>([
        { sender: 'ai', text: "Hello! I'm your personal AI Coach. How can I help you improve your productivity or skills today?" }
    ]);
    ...
    return (
        <>
            <div className="mb-8">
                <h1 className="text-3xl font-bold">Your Personal AI Coach</h1>
