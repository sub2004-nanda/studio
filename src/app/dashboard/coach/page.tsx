...
export default function CoachPage() {
    const [messages, setMessages] = useState<Message[]>([
        { sender: 'ai', text: "Hello! I'm your personal productivity coach. How can I help you improve your skills or workflow today?" }
    ]);
